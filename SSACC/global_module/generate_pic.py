...
def load_dataset(Dataset):
    mat_data = sio.loadmat('/home/nlabtest08/DBDA/datasets/Indian_pines_corrected.mat')
    mat_gt = sio.loadmat('/home/nlabtest08/DBDA/datasets/Indian_pines_gt.mat')
...
def load_dataset1(Dataset):
    uPavia = sio.loadmat('/home/nlabtest08/DBDA/datasets/PaviaU.mat')
    gt_uPavia = sio.loadmat('/home/nlabtest08/DBDA/datasets/PaviaU_gt.mat')
...
def load_dataset2(Dataset):
    SV = sio.loadmat('/home/nlabtest08/DBDA/datasets/Salinas_corrected.mat')
    gt_SV = sio.loadmat('/home/nlabtest08/DBDA/datasets/Salinas_gt.mat')
...
def sampling(proportion, ground_truth):
    ...
    for i in range(m):
        ...
        test_indexes += test[i]
    np.random.shuffle(train_indexes)#重新排序返回一个随机序列
    np.random.shuffle(test_indexes)
    return train_indexes, test_indexes

def aa_and_each_accuracy(confusion_matrix):
    list_diag = np.diag(confusion_matrix)#一维数组的形式返回方阵的对角线
    list_raw_sum = np.sum(confusion_matrix, axis=1)
    each_acc = np.nan_to_num(truediv(list_diag, list_raw_sum))#用零替换NaN，用最大的有限数替换无穷大
...
def generate_png(all_iter, net, gt_hsi, Dataset, device, total_indices):
    ...
    path = '/home/nlabtest08/DBDA/result'
    classification_map(y_re, gt_hsi, 300,
                       path + '/classification_maps/' + net.name + '.png')
    classification_map(gt_re, gt_hsi, 300,
                       path + '/classification_maps/' + '_gt.png')
